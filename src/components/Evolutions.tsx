...
const Evolutions: FC<EvolutionProps> = ({ evolutionChain }) => {
	return (
		<div className="justify-center md:w-[90%] lg:w-2/4 mt-4 md:mx-auto">
			...
			<div className="xxs:grid xxs:grid-cols-1 lg:flex place-items-center py-10 xxs:px-5 xl:px-20 items-center justify-center 
			bg-gray-200 dark:bg-[#272727] 
				...
				<div className="xxs:grid xxs:grid-flow-col xxs:grid-rows-1 xxs:auto-cols-auto lg:flex lg:flex-col lg:place-items-center 
				xxs:space-x-5 lg:space-x-0 w-fit">
					{evolutionChain?.chain?.evolves_to.length > 0 && evolutionChain?.chain?.evolves_to?.map((item) => (
						<div className="xxs:grid xxs:place-items-center lg:grid-flow-col">
							...
							<div className='xxs:grid xxs:grid-flow-col xxs:grid-rows-1 xxs:auto-cols-auto lg:flex lg:flex-col xxs:space-x-5 
							lg:space-x-0 w-fit'>
